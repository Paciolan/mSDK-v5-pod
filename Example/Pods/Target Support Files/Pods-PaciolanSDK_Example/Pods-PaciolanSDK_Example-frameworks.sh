...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/PaciolanSDK/PaciolanSDK.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-encrypted-storage/react_native_encrypted_storage.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-safe-area-context/react_native_safe_area_context.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-select-contact/react_native_select_contact.framework"
